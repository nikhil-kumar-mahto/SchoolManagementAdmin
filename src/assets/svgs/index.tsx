...
export const DeleteIcon = ({ size = 24, color = "#d32f2f", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const EditIcon = ({ size = 24, color = "#1976d2", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <path
          ...
          stroke={stroke}
        />
        <line x1="6.35" y1="20.63" x2="51.17" y2="20.63" stroke={stroke} />
        <line x1="16.46" y1="9.63" x2="16.46" y2="4.63" stroke={stroke} />
        <line x1="40.42" y1="9.63" x2="40.42" y2="4.63" stroke={stroke} />
        <circle cx="45.22" cy="45.44" r="12.43" stroke={stroke} />
        <polyline points="45.22 36.7 45.22 45.82 49.57 49.16" stroke={stroke} />
      </g>
    </svg>
  );
};

export const ClassIcon = ({ stroke = "#000000" }) => {
  return (
    <svg
      viewBox="0 0 64 64"
      xmlns="http://www.w3.org/2000/svg"
...
export const PlusCircleIcon = ({ color = "#0056b3", ...props }) => (
  <svg
    viewBox="0 0 32 32"
    version="1.1"
    xmlns="http://www.w3.org/2000/svg"
...
export const IconViewOff: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const DownArrowIcon : React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="#000000"
      {...props} // Spread any additional props like style or className
    >
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g
        id="SVGRepo_tracerCarrier"
...
export const TickIcon = () => {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#4CAF50">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g
        id="SVGRepo_tracerCarrier"
        strokeLinecap="round"
